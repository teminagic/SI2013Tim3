...
public class PromjenaVlasnikaVozila extends JPanel {
	...
	public void setPanel(){
		panel = new JPanel();
		panel.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Promjena vlasnika vozila", TitledBorder.LEADING, TitledBorder.TOP, null, Color.DARK_GRAY));
		...
		gbl_panel.columnWidths = new int[]{0, 109, 16, 0, 123, 0, 0};
		gbl_panel.rowHeights = new int[]{22, 0, 0, 0, 0, 0, 33, 0};
	...
	public void setInput(){
		...
		gbc_tfBrojVlasnickeDozvole.insets = new Insets(0, 0, 5, 5);
		gbc_tfBrojVlasnickeDozvole.fill = GridBagConstraints.HORIZONTAL;
		gbc_tfBrojVlasnickeDozvole.gridx = 3;
	...
	public void setComponents(){
		...
		ButtonGroup radioGroup = new ButtonGroup();
				...
				gbc_lblJmbgNovogVlasnika.gridx = 1;
				gbc_lblJmbgNovogVlasnika.gridy = 3;
				...
				gbc_tfJMBGNovogVlasnika.insets = new Insets(0, 0, 5, 5);
				gbc_tfJMBGNovogVlasnika.fill = GridBagConstraints.HORIZONTAL;
				gbc_tfJMBGNovogVlasnika.gridx = 3;
				gbc_tfJMBGNovogVlasnika.gridy = 3;
				...
				gbc_btnAzurirajPodatke.insets = new Insets(0, 0, 5, 5);
				gbc_btnAzurirajPodatke.gridx = 3;
				gbc_btnAzurirajPodatke.gridy = 5;
